<?php
session_start();
// Create connection  mysqli_connect("localhost", $_SESSION["ac"], $_SESSION["pw"], "new_scs");
...
$query = " SELECT * FROM emp_proj WHERE emp_id = '$ac' ORDER BY P_id ";
$result = mysqli_query($conn, $query);
$query2 = " SELECT * FROM emp_proj WHERE emp_id = '$ac' ORDER BY P_id ";
      ...
      resources: [
        <?php  
          while($row = mysqli_fetch_array($result)) {
				?>
            { id: '<?php echo $row["P_id"] ?>', title: '<?php echo $row["loc_addr"]?>' },
        <?php  
          }  
        ?>
      ],
...
<div class="w3-sidebar w3-bar-block w3-collapse w3-card" style="width:200px;" id="mySidebar">
            ...
            <nav class="sidebar-nav">
                <ul>
                  <li>
                    <a href="mgr_project.php"><img src="img\project.png"><span>專案</span></a>
                  </li>
                  <li>
                    <a href="emp_employee.php"><img src="img\staff.png"><span>員工管理</span></a>
                  </li>
                  <li>
