                ...
                <div class="w3-container">
                    ...
                    <div class="form-style-1">
                        ...
                        <div class="member_job_list">
                            <h3 style="padding-top: 20px;">員工委派</h3><hr>
                            <table style="margin-bottom: 20px;">
                                <tr>
                                    <th class="bold2">員工</th>
                                    <th class="bold2" style="width: 40px;">領隊</th>
                                    <th class="bold2" style="width: 390px;">工作詳情</th>
                                </tr>
                                <tr>
                                    <td>P_ID&emsp;P_Name;</td>
                                    <td>
                                    <label for="radio1" style="text-align: center;">                <!--leaderflag-->
                                    <input type="radio" id="E_id" name="flag" value="E_id" checked>
                                    </label>
                                    </td>
                                    <td>
                                        <textarea class="textarea-field" name="job_detail" style="width:390px"></textarea>
                                    </td>
                                </tr>
                            </table>
                        </div>
